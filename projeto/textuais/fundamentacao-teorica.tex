...
O sensor \textbf{vetor de rotação}, representa a orientação do aparelho como uma combinação de um angulo e um eixo, no qual o dispositivo rotacionou com um ângulo $\theta$ em torno de um eixo ($x$, $y$ ou $z$) \citeonline{google2019devsensors}. \par
